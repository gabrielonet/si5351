...
import utime
import clock_builder

i2c=I2C(0,sda=Pin(0),scl=Pin(1),freq=9000000)
print (i2c.scan())
...
def Si5351_init():
     ...
     Si5351_write(OUTPUT_CTRL,0xFE) #Enable CLOK0, CLock 1 or 2, depending by refistry value
...
x = clock_builder.gabriel (6.0013)
print (x)

#Si5351_init()
#PLLA_set(9000000) # Exprimat in Herti
#MS0_set()


###   Code not ready yet , To be continued
